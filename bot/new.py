...
# Apply lemmatization and filter out words in ignoreLetters
...
pickle.dump(lemmatized_words, open('words.pkl', 'wb'))
...
trainX = training[:, :len(lemmatized_words)]
trainY = training[:, len(lemmatized_words):]
